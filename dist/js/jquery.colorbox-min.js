  ...
  function f() {
    !g &&
      ...
      (g = o(lt)
        ...
        .hide()),
      (w = o(lt, "Overlay").hide()),
      (F = e([o(lt, "LoadingOverlay")[0], o(lt, "LoadingGraphic")[0]])),
      (v = o(lt, "Wrapper")),
      (y = o(lt, "Content").append(
        (L = o(lt, "Title")),
        (S = o(lt, "Current")),
            ...
            .one("load", function () {
              ...
              f === at &&
                ...
                B.retinaImage &&
                  ...
                  ((j.height = j.height / i.devicePixelRatio),
                ...
                B.scalePhotos &&
                  ...
                  B.mw &&
                    j.width > B.mw &&
                    ((t = (j.width - B.mw) / j.width), r()),
                  B.mh &&
                    j.height > B.mh &&
                    ((t = (j.height - B.mh) / j.height), r())),
                B.h &&
                  (j.style.marginTop = Math.max(B.mh - j.height, 0) / 2 + "px"),
                k[1] &&
                  (B.loop || k[z + 1]) &&
