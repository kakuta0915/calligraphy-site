...
const postcssOption      = [
    flexBugsFixes,
    autoprefixer(['last 3 versions', 'ie >= 8', 'Android >= 4', 'iOS >= 8'],autoprefixerOption),
...
// タスク実行
gulp.task('default', gulp.series(gulp.parallel('watch-files', 'browser-sync', 'ejs', 'sass', 'imagemin'), (done) => {
    done()
}))